...
def jouerCarte(labyrinthe, direction, rangee):
    ...
    if direction == "N":
        ...
        carte["Pions"] = []
        labyrinthe["Plateau"] = (
        getPlateau(labyrinthe)[0], decalageColonneEnHaut(getPlateau(labyrinthe)[0], rangee, getCarteAJouer(labyrinthe)))
    if direction == "S":
        ...
        carte["Pions"] = []
        labyrinthe["Plateau"] = (
        getPlateau(labyrinthe)[0], decalageColonneEnBas(getPlateau(labyrinthe)[0], rangee, getCarteAJouer(labyrinthe)))
    if direction == "O":
        ...
        carte["Pions"] = []
        labyrinthe["Plateau"] = (
        getPlateau(labyrinthe)[0], decalageLigneAGauche(getPlateau(labyrinthe)[0], rangee, getCarteAJouer(labyrinthe)))
    if direction == "E":
        ...
        carte["Pions"] = []
        labyrinthe["Plateau"] = (
        getPlateau(labyrinthe)[0], decalageLigneADroite(getPlateau(labyrinthe)[0], rangee, getCarteAJouer(labyrinthe)))
