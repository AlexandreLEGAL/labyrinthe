...
class TestCarte(unittest.TestCase):
    ...
    def test_murNord(self):
        for i in range(13):
            if i not in (7, 11):
                if i & self.N == self.N:
                    self.assertTrue(carte.murNord(self.liste_cartes[i]),
    ...
    def test_murSud(self):
        for i in range(13):
            if i not in (7, 11):
                if i & self.S == self.S:
                    self.assertTrue(carte.murSud(self.liste_cartes[i]),
                                    "la carte " + str(self.liste_cartes[i]) + " devrait posséder un mur au sud")
                else:
                    self.assertFalse(carte.murSud(self.liste_cartes[i]),
    ...
    def test_murOuest(self):
        for i in range(13):
            if i not in (7, 11):
                if i & self.O == self.O:
                    self.assertTrue(carte.murOuest(self.liste_cartes[i]),
    ...
    def test_murEst(self):
        for i in range(13):
            if i not in (7, 11):
                if i & self.E == self.E:
                    self.assertTrue(carte.murEst(self.liste_cartes[i]),
    ...
    def test_listePions(self):
        ...
        self.assertEqual(carte.getListePions(c1), [1, 2],
        ...
        self.assertEqual(carte.getListePions(c2), [],
    ...
    def test_getNbPions(self):
        c1 = carte.Carte(True, False, True, False)
        c2 = carte.Carte(True, False, True, False, pions=[1, 3])
        self.assertEqual(carte.getNbPions(c1), 0,
                         "la carte " + str(c1) + " devrait avoir un nombre de pions égal à 0\n" +
                         "Le problème vient sans doute de la fonction Carte")
        self.assertEqual(carte.getNbPions(c2), 2,
    ...
    def test_possede_Pion(self):
        ...
        c2 = carte.Carte(True, False, True, False, pions=[1, 3])
        for i in range(1, 5):
            self.assertFalse(carte.possedePion(c1, i),
        ...
        for i in range(1, 5):
            if i == 1 or i == 3:
                self.assertTrue(carte.possedePion(c2, i),
                                "la carte " + str(c2) + " possède bien le pion " + str(i) + "\n" +
                                "Le problème vient sans doute de la fonction Carte ou de la fonction possedePion")
            else:
                self.assertFalse(carte.possedePion(c2, i),
    ...
    def test_possede_pendre_Pion(self):
        ...
        for nb in range(2):
            ...
            for i in range(1, 5):
                if i == 1:
                    self.assertTrue(carte.possedePion(c1, i),
    ...
    def test_possede_poser_Pion(self):
        ...
        for i in range(1, 5):
            if i == 1 or i == 3 or i == 4:
                ...
                self.assertFalse(carte.possedePion(c2, 2),
                                 "la carte " + str(c2) + " ne possède pas le pion " + str(i) + "\n" +
                                 "Le problème vient sans doute de la fonction poserPion ou de la fonction possedePion")
    ...
    def test_getTresor(self):
        ...
        self.assertEqual(carte.getTresor(c1), 0,
        ...
        self.assertEqual(carte.getTresor(c2), 10,
    ...
    def test_getTresor_mettreTresor(self):
        c1 = carte.Carte(True, False, True, False)
        c2 = carte.Carte(True, False, True, False, 10)
        self.assertEqual(carte.mettreTresor(c1, 5), 0,
        ...
        self.assertEqual(carte.mettreTresor(c2, 7), 10,
    ...
    def test_getTresor_prendreTresor(self):
        c1 = carte.Carte(True, False, True, False)
        c2 = carte.Carte(True, False, True, False, 10)
        self.assertEqual(carte.prendreTresor(c1), 0,
                         "la carte " + str(c1) + " ne possèdait aucun trésor => valeur attendue 0\n" +
        ...
        self.assertEqual(carte.prendreTresor(c2), 10,
                         "la carte " + str(c2) + " possédait le trésor 10 => valeur attendue 10\n" +
                         "Le problème vient sans doute de la fonction Carte ou de la fonction prendreTresor")
    ...
    def test_toChar(self):
        for i in range(16):
            ...
            self.assertEqual(carac, carte.listeCartes[i], "la carte " + str(self.liste_cartes[i]) +
                             " devrait avoir pour caractère " + carte.listeCartes[i] + " mais toChar retourne " + str(
                carac))
